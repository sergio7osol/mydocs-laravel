<x-layout :pageTitle="$pageTitle" :users="$users" :currentUserId="$document->user_id" :userDocCounts="$userDocCounts"
  :currentCategory="$document->category_id" :documents="$documents">
