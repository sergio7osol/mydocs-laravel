			...
			<div class="content">
				...
				<div class="content-header">
					...
					<div class="search-container">
						<form action="{{ route('documents.search') }}" method="GET" class="search-form" role="search">
							@csrf
							@if (isset($currentCategory) && !empty($currentCategory))
								<input type="hidden" name="category" value="{{ $currentCategory }}">
							@endif
							<label for="search-input" class="search-form__label">Search documents</label>
							<input type="text" 
							       id="search-input" 
							       name="q" 
							...
							@if ($currentUserId)
								...
								@endphp
								@if ($disableUpload)
									<a href="{{ $uploadUrl }}" class="upload-button is-disabled-link" aria-disabled="true" title="You can't upload to this category"
										aria-label="Upload document (disabled)">Upload Document</a>
								@else
									<a href="{{ $uploadUrl }}" class="upload-button" aria-label="Upload a new document">Upload Document</a>
								@endif
							@endif
						</form>
					</div>
									...
									<div class="document-details">
										...
										<div class="document-meta">
											...
											@if ($doc->labels->isNotEmpty())
												<span class="document-labels" aria-label="Document labels">
